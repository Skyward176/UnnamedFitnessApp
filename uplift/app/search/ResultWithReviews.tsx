...
const ResultWithReviews = ({reviews, setShowReviewForm, display, handleRoutineClick, docData}) => {
        ...
        return(
            <>
                <div style={{display: display}} className='flex flex-col h-full w-1/2'>
                    ...
                    <ReviewList reviews={reviews} setShowForm = {setShowReviewForm} routineId = {docData._firestore_id} />
                </div>
