        ...
        <div className='flex flex-col flex-wrap h-full w-full overflow-hidden'>
                ...
                <DocrefContext.Provider value={ docRef }>
                    <div className='w-screen grow flex lg:flex-row flex-col text-white'>
                        <div className='flex flex-col overflow-y-scroll overflow-scroll justify-center items-center lg:w-1/2 lg:h-full w-full h-1/2 border-b border-b-white lg:border-b-0 lg:border-r lg:border-r-white'>
